...
use app\models\MMeetingTimeSearch;
 ...
 */
class MMeetingTimeController extends Controller
{
    /**
     * @inheritdoc
     */
    ...
    {
        $searchModel = new MMeetingTimeSearch();
     ...
     * @param integer $id
     * @return MMeetingTime the loaded model
     * @throws NotFoundHttpException if the model cannot be found
     */
    protected function findModel($id)
    {
        if (($model = MMeetingTime::findOne($id)) !== null) {
            return $model;
        }
