...
use app\models\MParticipantSearch;
 ...
 */
class MParticipantController extends Controller
{
    /**
     * @inheritdoc
     */
    ...
    {
        $searchModel = new MParticipantSearch();
     ...
     * @param integer $id
     * @return MParticipant the loaded model
     * @throws NotFoundHttpException if the model cannot be found
     */
    protected function findModel($id)
    {
        if (($model = MParticipant::findOne($id)) !== null) {
            return $model;
        }
